 ...
 */
final class Version20211020032117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE books ADD owner_id INT NOT NULL');
        $this->addSql('ALTER TABLE books ADD CONSTRAINT FK_4A1B2A927E3C61F9 FOREIGN KEY (owner_id) REFERENCES user (id)');
